...
import { ManualBankTransferSettingsSection } from './manual-bank-transfer-settings-section'
...
const BILLING_SECTIONS = [
  ...
  },
  {
    ...
    titleKey: 'Manual Bank Transfer',
    build: (settings: BillingSettings) => (
      <ManualBankTransferSettingsSection
        defaultConfig={settings['manual_bank_transfer.config']}
        complianceConfirmed={
          (settings['payment_setting.compliance_confirmed'] ?? false) &&
          settings['payment_setting.compliance_terms_version'] === 'v1'
        }
