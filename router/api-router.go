...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/oen/webhook", anonymousRequestBodyLimit, controller.OenWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/request-content-access", middleware.DisableCache(), controller.RequestContentAccess)
				adminRoute.PUT("/:id/request-content-access", controller.RequestContentAccess)
		...
		logRoute.GET("/content/:request_id", middleware.DisableCache(), middleware.AdminAuth(), controller.GetRequestContent)
		logRoute.GET("/self/content/:request_id", middleware.DisableCache(), middleware.UserAuth(), controller.GetRequestContent)
